...
var FlickrLightbox = (_temp = _class = function (_Component) {
  ...
  this.generateApiUrl = function (props) {
    var extras = ["url_o", "url_m", "url_sq", "license", "date_upload", "date_taken", "icon_server", "original_format", "last_update", "geo", "tags", "machine_tags", "o_dims", "views", "media", "path_alias", "owner_name"];
